        ...
        <NuxtLayout name="admin">
            <main>
                ...
                <div v-if="showForm" class="fixed inset-0 flex items-center justify-center bg-gray-700 bg-opacity-50">
                    <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
                        <div class="text-center mb-7">
                            <h2 class="text-xl font-semibold text-gray-800">Adjustement Details Form</h2>
                        </div>
                        <form @submit.prevent="saveAdjustment">
                            ...
                            <div class="grid grid-cols-1 gap-1 mt-3 mx-2">
                                ...
                                <div class="flex items-center mb-1">
                                    <FormTextField id="invadjustmentno" name="invadjustmentno"
                                        v-model="adjustments.invadjustmentno" placeholder="Inv Adjustment No" />
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <div class="flex items-center mb-1 ">
                                        <FormTextField id="remarks" name="remarks" v-model="adjustments.remarks"
                                            placeholder="Remarks" />
                ...
                <div v-if="adjustmentToView"
                    ...
                    <div class="text-center mb-7">
                            <h2 class="text-xl font-semibold text-gray-800">Adjustement Details</h2>
                        </div>
                    <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
                        <div class="grid grid-cols-1 gap-1 mt-3 mx-2">
