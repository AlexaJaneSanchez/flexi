<template>
    ...
    <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div class="bg-white">
            ...
            <main>
                <!-- Hero section -->
                <div class="relative pt-10 absolute">
                    <div class="mx-auto ml-10 max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
                    <!-- The content part: Text section -->
                    <div class="flex-shrink-0">
                        <h1 class="mt-10 max-w-lg text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">The
                            point of sale of every sale</h1>
                        <p class="mt-6 text-lg leading-8 text-gray-600">Discover the future of smooth transaction.</p>
                        <p class="mt-2 text-lg leading-8 text-gray-600">Get our user-friendly POS system to manage sales, track
                            inventory, and improve your business efficiency.</p>
                    ...
                    <!-- The image section -->
                    <div class="mt-16 sm:mt-24 lg:mt-0 flex-shrink-0">
                        <svg viewBox="0 0 800 800" role="img" class="mx-auto w-full max-w-full drop-shadow-xl">
                            <title>POS image</title>
                            <foreignObject width="100%" height="100%" x="0" y="0">
                                <img src="/images/Background.png" alt="Background" class="object-contain w-full h-auto max-w-full" />
                            </foreignObject>
                        </svg>
                    </div>
                </div>
    ...
    <!--  <div class="bg-white"> 
            <main> 
                ...
                <div class="mx-auto mt-16 max-w-7xl px-6 sm:mt-32 lg:px-8">
                    ...
                    <p class="mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-gray-600">Choose an affordable
                        plan that’s packed with the best features for engaging your audience, creating customer loyalty,
                        and driving sales.</p>
                            ...
                            <div class="mx-auto max-w-2xl space-y-16">
                                <div v-for="tier in pricing.tiers" :key="tier.id" class="border-t border-gray-900/10">
                                    <div
                                        ...
                                        <h3
                                            :class="[tier.featured ? 'text-indigo-600' : 'text-gray-900', 'text-sm font-semibold leading-6']">
                                            {{ tier.name }}</h3>
                                    ...
                                    <div class="mt-10 space-y-10">
                                        <div v-for="section in pricing.sections" :key="section.name">
                                            <h4 class="text-sm font-semibold leading-6 text-gray-900">{{ section.name }}
                                            </h4>
                        ...
                        <section aria-labelledby="comparison-heading" class="hidden lg:block">
                            ...
                            <div class="grid grid-cols-4 gap-x-8 border-t border-gray-900/10 before:block">
                                <div v-for="tier in pricing.tiers" :key="tier.id" aria-hidden="true" class="-mt-px">
                                    <div
                                        :class="[tier.featured ? 'border-indigo-600' : 'border-transparent', 'border-t-2 pt-10']">
                                        <p
                                            :class="[tier.featured ? 'text-indigo-600' : 'text-gray-900', 'text-sm font-semibold leading-6']">
                                            {{
                                                tier.name }}</p>
                                                    ...
                                                    <td v-for="tier in pricing.tiers" :key="tier.id"
                                                        ...
                                                        <span class="relative h-full w-full py-3">
                                                            <span v-if="typeof feature.tiers[tier.name] === 'string'"
                                                                :class="[tier.featured ? 'font-semibold text-indigo-600' : 'text-gray-900', 'text-sm leading-6']">{{
                                                                    feature.tiers[tier.name] }}</span>
                                                            <template v-else>
                                                                <CheckIcon v-if="feature.tiers[tier.name] === true"
                                                                    class="mx-auto h-5 w-5 text-indigo-600"
                ...
                <div class="mx-auto mt-24 max-w-7xl px-6 sm:mt-32 lg:px-8">
                    ...
                    <div class="mt-16 flex justify-center">
                        <p
                            ...
                            <span class="hidden md:inline">Transistor saves up to $40,000 per year, per employee by
            ...
            <div class="mx-auto mt-20 max-w-lg space-y-16">
                <div class="flex gap-x-6">
                    ...
                    <div>
                        ...
                        <p class="mt-2 leading-7 text-gray-600">Ut cursus est ut amet. Lobortis eget egestas leo vitae
                            eget porttitor risus blandit. Nunc a in lorem vel iaculis porttitor.</p>
                        <p class="mt-4">
                            <a href="#" class="text-sm font-semibold leading-6 text-indigo-600">Contact us <span
                ...
                <div class="flex gap-x-6">
                    ...
                    <div>
                        ...
                        <p class="mt-2 leading-7 text-gray-600">Expedita qui non ut quia ipsum voluptatum ipsam
                            pariatur. Culpa vitae ipsum minus eius vero quo quibusdam.</p>
                        <p class="mt-4">
                            <a href="#" class="text-sm font-semibold leading-6 text-indigo-600">Report a bug <span
                                    aria-hidden="true">&rarr;</span></a>
                        </p>
                    </div>
                </div>
                <div class="flex gap-x-6">
                    <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-indigo-600">
                        <ComputerDesktopIcon class="h-6 w-6 text-white" aria-hidden="true" />
                    </div>
                    <div>
                        <h3 class="text-base font-semibold leading-7 text-gray-900">Technical support</h3>
                        <p class="mt-2 leading-7 text-gray-600">Sint aut modi porro consequatur architecto commodi qui
                            consequatur. Dignissimos adipisci minima.</p>
                        <p class="mt-4">
                            <a href="#" class="text-sm font-semibold leading-6 text-indigo-600">Join our Discord <span
                                    aria-hidden="true">&rarr;</span></a>
                        </p>
                    </div>
                </div>
        ...
        <div class="mx-auto max-w-7xl px-6 py-16 sm:py-24 lg:px-8 lg:py-32">
            <div class="xl:grid xl:grid-cols-3 xl:gap-8">
                <img class="h-7" src="/public/images/Logo.png" alt="Company name" />
